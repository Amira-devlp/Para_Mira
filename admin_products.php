...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <div class="flex">
         ...
         <select name="category" class="box" required>
            <option value="" selected disabled>Selectionner la catégorie</option>
               ...
               <option value="Bebe">Bébe & Maman</option>
      ...
      <textarea name="details" class="box" required placeholder="Entrez détails du produit" cols="30" rows="10"></textarea>
...
<section class="show-products">
   ...
   <?php
      ...
      echo '<p class="empty">Pas de produits ajoutés encore</p>';
   }
   ?>
