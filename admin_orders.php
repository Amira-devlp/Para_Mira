...
if(isset($_POST['update_order'])){
   ...
   $message[] = 'Le payement a été mis à jour !';
...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <p> Identifiant : <span><?= $fetch_orders['user_id']; ?></span> </p>
         ...
         <form action="" method="POST">
            ...
            <div class="flex-btn">
               ...
               <a href="admin_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('supprimer cette commande ?');">Supprimer</a>
            </div>
         </form>
      </div>
      <?php
