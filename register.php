...
<section class="form-container">
   ...
   <form action="" enctype="multipart/form-data" method="POST">
      ...
      <input type="text" name="name" class="box" placeholder="Entrez votre Prénom.." required>
      <input type="email" name="email" class="box" placeholder="Entrez Votre @Mail.." required>
