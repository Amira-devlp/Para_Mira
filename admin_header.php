...
<header class="header">
   ...
   <div class="flex">
      ...
      <a href="admin_page.php" class="logo">Espace<span>Admin</span></a>
      ...
      <div class="profile">
         ...
         ?>
         <img src="uploaded_img/<?= $fetch_profile['image']; ?>" alt="C'est Moi">
         <p><?= $fetch_profile['name']; ?></p>
         <a href="admin_update_profile.php" class="btn">Mettre à jour Profile</a>
